...
insert event_def(name, shortName, stage,createdTime,lastModifiedTime) values ("预赛","A", 1, now(), now());
insert event_def(name, shortName, stage,createdTime,lastModifiedTime) values ("复赛","B", 2, now(), now());
insert event_def(name, shortName, stage,createdTime,lastModifiedTime) values ("决赛","C", 3, now(), now());
