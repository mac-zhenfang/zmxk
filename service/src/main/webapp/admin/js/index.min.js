...
Module.directive('datePicker', ['datePickerConfig', 'datePickerUtils', '$rootScope', function datePickerDirective(datePickerConfig, datePickerUtils, $rootScope) {
  ...
  return {
    ...
    link: function (scope, element, attrs, ngModel) {
      ...
      scope.itemmodel = attrs.itemmodel;
      ...
      scope.setDate = function (date) {
        ...
        if ((!nextView || partial) || scope.model) {
          ...
          //console.log(date);
          $rootScope.$broadcast('setDate1', scope.model, scope.itemmodel)
          //scope.$parent.$emit('setDate', scope.model, scope.view);
...
Module.constant('dateTimeConfig', {
  template: function (attrs) {
	//console.log(attrs.itemmodel);
    return '' +
        '<div ' +
        'date-picker="' + attrs.ngModel + '" ' +
        (attrs.itemmodel? 'itemmodel="'+attrs.itemmodel + '" ' : '') +
