...
//	$("#myTab a:first").tab("show");
	...
	$(".progressUploadAnimate")
			.progressbar(
					{
						value : 1,
						create : function() {
							$(".progressUploadAnimate .ui-progressbar-value")
									.animate(
											{
												width : "100%"
											},
											{
												...
												complete : function() {
													$(
															".progressUploadAnimate + .field_notice")
															.html(
																	"<span class='must'>Upload Finished</span>")
												}
											})
						}
					});
	...
	if ($(".progressBarValue")) {
		$(".progressBarValue")
				.each(
						function() {
							var c = $(this).find(".progressCustomValueVal")
									.html();
							var b = parseInt(c);
							$(this)
