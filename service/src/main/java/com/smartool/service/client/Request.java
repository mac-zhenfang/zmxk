...
public class Request<T extends HttpRequestBase> {
    ...
    public Request<T> trackingId(String trackingId) {
        header(Client.TRACKING_ID, trackingId);
        return this;
    }
    ...
    public Request<T> range(Long fromBytes, Long toBytes) {
        ...
        if (fromBytes != null) sb.append(fromBytes);
        sb.append('-');
        if (toBytes != null) sb.append(toBytes);
